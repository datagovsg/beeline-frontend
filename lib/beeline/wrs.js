...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! /home/daniel/beeline-frontend/beeline/wrs.js */1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getIterator2 = __webpack_require__(/*! babel-runtime/core-js/get-iterator */ 2);
	...
	var _promise = __webpack_require__(/*! babel-runtime/core-js/promise */ 59);

	var _promise2 = _interopRequireDefault(_promise);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	angular.module('wrs', ['beeline']).config(function ($stateProvider, $urlRouterProvider) {
	  $stateProvider.state('tracking', {
	    url: '/tracking/{routeId:int}'
	  }).state('tracking-date', {
	    url: '/tracking/{routeId:int}/{date}'
	  });
	  ...
	  return function (date) {
	    ...
	    date = typeof date == 'string' ? new Date(date) : typeof date == 'number' ? new Date(date) : date;

	    var timeDiff = new Date().getTime() - date.getTime();

	    return timeDiff < 3600 * 1000 ? (timeDiff / 60000).toFixed(0) + ' minutes ago' : timeDiff < 24 * 3600 * 1000 ? (timeDiff / 3600 / 1000).toFixed(0) + ' hours ago' : (timeDiff / 3600 / 1000 / 24).toFixed(0) + ' days ago';
	  };
	}).controller('TrackingCtrl', function ($scope, MapOptions, TripService, CompanyService, RoutesService, $stateParams, $state, $rootScope, $timeout, uiGmapGoogleMapApi) {

	  var tripPromise = null;
	  var routePromise = null;
	  var companyPromise = null;

	  // icons and all require googleMaps
	  uiGmapGoogleMapApi.then(function (googleMaps) {
	    _.assign($scope.map.busMarker, {
	      coords: null,
	      icon: {
	  ...
	  $rootScope.$on('$stateChangeSuccess', function (toState, fromState) {
	    if (!$stateParams.routeId) return;

	    // We have route id
	    if ($stateParams.date) {
	      var dt = new Date($stateParams.date);
	      dt.setHours(0, 0, 0, 0);

	      routePromise = RoutesService.getRoute($stateParams.routeId, {
	        start_date: dt.getTime(),
	        end_date: dt.getTime() + 24 * 60 * 60 * 1000,
	        include_trips: true
	      });
	    } else {
	      var dt = new Date();
	    ...
	    tripPromise = routePromise.then(function (route) {
	      return route.trips[0];
	    });
	    companyPromise = tripPromise.then(function (trip) {
	    ...
	    // Force a ping
	    $scope.map.lastPing = null;
	    tripPromise.then(reping);
	    ...
	    // Show the stops
	    _promise2.default.all([tripPromise, uiGmapGoogleMapApi]).then(function (_ref) {
	      var _ref2 = (0, _slicedToArray3.default)(_ref, 2);

	      var trip = _ref2[0];
	      var googleMaps = _ref2[1];
	      ...
	      try {
	        for (var _iterator = (0, _getIterator3.default)(trip.tripStops), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          var tripStop = _step.value;

	          var coords = tripStop.stop.coordinates.coordinates;
	          if (tripStop.canBoard) {
	            $scope.map.markers.push({
	              id: tripStop.id,
	              coords: { latitude: coords[1], longitude: coords[0] },
	              icon: {
	                url: 'img/MapRoutePickupStop.png',
	                scaledSize: new googleMaps.Size(25, 25),
	                anchor: new googleMaps.Point(13, 13)
	              },
	              tripStop: tripStop
	            });
	          } else if (tripStop.canAlight) {
	            $scope.map.markers.push({
	              id: tripStop.id,
	              coords: { latitude: coords[1], longitude: coords[0] },
	              icon: {
	                url: 'img/MapRouteDropoffStop.png',
	                scaledSize: new googleMaps.Size(25, 25),
	                anchor: new googleMaps.Point(13, 13)
	              },
	              tripStop: tripStop
	  ...
	  function reping() {
	    if (!tripPromise) return _promise2.default.resolve(null);
	  ...
	  var pingTimer;
	  var pingLoop = function pingLoop() {
	    reping().then(function (info) {
	      console.log(info);
	      pingTimer = $timeout(pingLoop, 5000);
	    }).catch(function (err) {
	      console.log(err);
	    });
	  };
	  ...
	  $scope.$watch('info', function () {
	    ...
	    $scope.map.lastPing = info.pings[0];
	  });

	  // Zoom to stop when a particular tripstop is clicked
	  $scope.zoomToStop = function (tripStop) {
	    ...
	    $scope.infoStop = tripStop;
	  };

	  // For filtering the stop list
	  $scope.infoStop = null;
	  $scope.filterBoard = function (tripStop) {
	    return tripStop.canBoard;
	  };
	  $scope.filterAlight = function (tripStop) {
	    return tripStop.canAlight;
	  };

	  // When markers are clicked
	  $scope.selectStop = function (what, event, model) {
	    console.log(arguments);
	    $scope.infoStop = model.tripStop;
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = { "default": __webpack_require__(/*! core-js/library/fn/get-iterator */ 3), __esModule: true };
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ../modules/web.dom.iterable */ 4);
	__webpack_require__(/*! ../modules/es6.string.iterator */ 50);
	module.exports = __webpack_require__(/*! ../modules/core.get-iterator */ 52);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ./es6.array.iterator */ 5);
	var global        = __webpack_require__(/*! ./_global */ 16)
	  , hide          = __webpack_require__(/*! ./_hide */ 20)
	  , Iterators     = __webpack_require__(/*! ./_iterators */ 8)
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var addToUnscopables = __webpack_require__(/*! ./_add-to-unscopables */ 6)
	  , step             = __webpack_require__(/*! ./_iter-step */ 7)
	  , Iterators        = __webpack_require__(/*! ./_iterators */ 8)
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ./_hide */ 20)(IteratorPrototype, __webpack_require__(/*! ./_wks */ 47)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $at  = __webpack_require__(/*! ./_string-at */ 51)(true);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! ./_core */ 17).getIterator = function(it){
	  var iterFn = get(it);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isIterable2 = __webpack_require__(/*! babel-runtime/core-js/is-iterable */ 56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = { "default": __webpack_require__(/*! core-js/library/fn/is-iterable */ 57), __esModule: true };
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ../modules/web.dom.iterable */ 4);
	__webpack_require__(/*! ../modules/es6.string.iterator */ 50);
	module.exports = __webpack_require__(/*! ../modules/core.is-iterable */ 58);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var classof   = __webpack_require__(/*! ./_classof */ 54)
	  , ITERATOR  = __webpack_require__(/*! ./_wks */ 47)('iterator')
	  , Iterators = __webpack_require__(/*! ./_iterators */ 8);
	module.exports = __webpack_require__(/*! ./_core */ 17).isIterable = function(it){
	  var O = Object(it);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = { "default": __webpack_require__(/*! core-js/library/fn/promise */ 60), __esModule: true };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LIBRARY            = __webpack_require__(/*! ./_library */ 14)
	  ...
	  , anInstance         = __webpack_require__(/*! ./_an-instance */ 63)
	  , forOf              = __webpack_require__(/*! ./_for-of */ 64)
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(/*! ./_ctx */ 18)(Function.call, __webpack_require__(/*! ./_object-gopd */ 68).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!setTask || !clearTask){
	  ...
	  // Node.js 0.8-
	  if(__webpack_require__(/*! ./_cof */ 11)(process) == 'process'){
	    defer = function(id){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global    = __webpack_require__(/*! ./_global */ 16)
	  ...
	  , process   = global.process
	  , Promise   = global.Promise
	  , isNode    = __webpack_require__(/*! ./_cof */ 11)(process) == 'process'
	  , head, last, notify;
