...
/**
  ...
  * tabs will be handled globally in main.js
  ...
  function (
    ...
    $window
      ...
      .state('intro', {
        ...
        controller: 'IntroSlidesController as introSlides',
      })
      .state('welcome', {
        url: '/welcome?refCode',
      ...
      // Main interface
      // ///////////////////////////////////////////////////////////////////////
      /** Instead of using abstract: true, we make this page not abstract,
          because we want to provide the $backOrDefault method to the tabs scope
      ...
      .state('tabs.route-summary', {
        url: '/route/:routeId/summary?' +
             'boardStop&alightStop&selectedDates&promoCode',
        views: {
          'tab-routes': {
