...
.controller('KickstartController', require('./controllers/KickstartController.js').default)
.controller('KickstartDetailController', require('./controllers/KickstartDetailController.js').default)
