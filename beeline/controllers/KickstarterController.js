...
export default [
  '$scope','$state', 'UserService', 'RoutesService', '$q', '$ionicScrollDelegate',
  '$ionicPopup', 'KickstarterService', '$ionicLoading', 'SearchService', '$timeout',
  'loadingSpinner', 'uiGmapGoogleMapApi', 'LazyLoadService', 'SearchEventService',
  'PlaceService',
