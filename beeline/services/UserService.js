...
export default ['$http', '$ionicPopup', '$ionicLoading', '$rootScope', 'LoginDialog', '$q', 'loadingSpinner',
  function UserService ($http, $ionicPopup, $ionicLoading, $rootScope, LoginDialog, $q, loadingSpinner) {
    ...
    let registerViaReferralWelcome = async function (telephoneNumber, refCode, refCodeOwner) {
      try {
        if (!telephoneNumber) return
    ...
    let promptUpdatePhone = async function () {
      try {
        ...
        let telephoneResponse = await promptTelephoneNumber('Update Phone Number',
