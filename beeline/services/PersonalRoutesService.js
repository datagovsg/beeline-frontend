angular.module("beeline").factory("PersonalRoutesService", [
  "RoutesService",
  "LiteRoutesService",
      ...
      return new Promise((resolve, reject) => {
        if (UserService.getUser() == null) {
          ...
          return Promise.all([
            ...
            LiteRouteSubscriptionService.getSubscriptions(),
            ...
            activatedCrowdstartRoutes = _.filter(
            ...
            routes = bookingRoutes
              .concat(activatedCrowdstartRoutes)
              .concat(subscribedLiteRoutes)
